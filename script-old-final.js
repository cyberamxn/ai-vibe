...
class ChatApp {
    ...
    async handleFormSubmit(e) {
        ...
        try {
            ...
            // Send message to API
            const response = await openRouterClient.sendChatMessage(this.conversation);
    ...
    handleNewChatClick() {
        ...
        // Add welcome message
        this.addMessage('bot', '🆕 New chat started! How can I help you today?');
    }
    ...
    handleSignupClick() {
        ...
        modal.querySelector('#signup-form').addEventListener('submit', (e) => {
            e.preventDefault();
            this.addMessage('bot', '✅ Sign up functionality is working! This is demo - in a real app, your account would be created now.');
            this.closeModal();
        });
    }
